...
void printUsage(const char* prog) {
    cout << "Usage: " << prog << " [OPTIONS]\n\n"
         ...
         << "  --metaheuristic <method>   none | mcts (default) | pso | ils\n"
...
int main(int argc, char* argv[]) {
    ...
    string datasource         = getArg(argc, argv, "--datasource", "../datasource/planilha.xlsx");
    ...
    validate(metaheuristicMethod, {"none","mcts","pso","ils"},        "--metaheuristic");
